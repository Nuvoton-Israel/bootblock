...
// Support Dell DDR device:
//#define               DENALI_CTL_50_DATA 0x00D00100 // TRFC_F0:RW:16:10:=0x0082 TREF_ENABLE:RW:8:1:=0x01 RESERVED:RW:0:1:=0x00
//#define               DENALI_CTL_50_DATA_1GIB 0x01180100 // TRFC_F0:RW:16:10:=0x0082 TREF_ENABLE:RW:8:1:=0x01 RESERVED:RW:0:1:=0x00
                                                         // **** 26-5-15 Yoel: changed tRFC to 118h  T.P.: For 1GiB  !!!!

// Support MT40A512M16LY-075:E - 1GB
#define               DENALI_CTL_50_DATA_DEFAULT 0x01B80100  // (=550ns) for 2GB memory and below

#define               DENALI_CTL_50_DATA 0x00D00100  // (=260ns) actually 280 ns, 20 ns spare
#define               DENALI_CTL_50_DATA_1GIB 0x01200100 // (=350ns) 10 ns spare
...
#define              DENALI_CTL_93_DATA_ECC 0x01000C00 // ECC_EN:RW:24:1:=0x01 MR6_DATA_F1_0:RW:0:17:=0x000400
#define              DENALI_CTL_94_DATA_ECC (0x00000000| (0x1 << ECC_DISABLE_W_UC_ERR_OFFSET))
   // ECC_DISABLE_W_UC_ERR:RW:24:1:=0x00 XOR_CHECK_BITS:RW:8:14:=0x0000 FWC:WR:0:1:=0x00
...
#define              DENALI_CTL_106_DATA 0x00000200 // ZQ_INTERVAL:RW:0:32:=0x00000200 //22/AUG/2016: changed from 40h (every ~82 us) to 200h (every ~656us)
...
#define              DENALI_CTL_107_DATA_1GIB 0x01000100 // COL_DIFF:RW:24:4:=0x01 ROW_DIFF:RW:16:3:=0x01 BANK_DIFF:RW:8:2:=0x01 ZQ_IN_PROGRESS:RD:0:1:=0x00
